...
<h5 align='center' id='architecture-loan-layer'>LOAN LAYER</h5>
...
<h5 align='center' id='architecture-risk-assessment-layer'>RISK-ASSESSMENT LAYER</h5>
...
<h4 align='center' id='loan-lifecycle'>LOAN LIFECYCLE</h4>
...
<h4 align='center' id='challenges'>CHALLENGES</h4>
...
<h4 align='center' id='attacks'>ATTACKS</h4>
...
<h4 align='center' id='miscellania'>MISCELLANIA</h4>
...
The activities of an RAA are very different from that of peer-to-peer lending websites, like LendingClub, insofar as LendingClub is a  centralized platform that matches borrowers and lenders for compensation, while an RAA's activities are more like those of a rating agency or credit reporting agency, rather than that of a broker-dealer.  The discovery and matching of borrowers and lenders happens entirely through open-source software  downloaded and used locally by the borrowers and the lenders acting in their own capacity without assistance from any centralized party acting as a platform.
...
<h4 align='center' id='footnotes'>FOOTNOTES</h4>
